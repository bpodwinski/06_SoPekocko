...
export class SaucesService {
  ...
  getSauces() {
    this.http.get("/api/sauces").subscribe(
      (sauces: Sauce[]) => {
  ...
  getSauceById(id: string) {
    return new Promise((resolve, reject) => {
      this.http.get("/api/sauces/" + id).subscribe(
        (sauce: Sauce) => {
          resolve(sauce);
        },
        (error) => {
  ...
  createSauce(sauce: Sauce, image: File) {
    return new Promise((resolve, reject) => {
      ...
      this.http.post("/api/sauces", formData).subscribe(
        (response: { message: string }) => {
          resolve(response);
        },
        (error) => {
  ...
  modifySauce(id: string, sauce: Sauce, image: string | File) {
    return new Promise((resolve, reject) => {
      if (typeof image === "string") {
        ...
        formData.append("sauce", JSON.stringify(sauce));
        formData.append("image", image);
        this.http.put("/api/sauces/" + id, formData).subscribe(
          (response: { message: string }) => {
            resolve(response);
          },
          (error) => {
